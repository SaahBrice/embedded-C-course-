# Full solution: Capstone: Buffer Records

This worked implementation demonstrates fixed capacity, full policy, ordering. Compare its observable behavior and boundaries with yours; different code is valid when it preserves the same contract.
