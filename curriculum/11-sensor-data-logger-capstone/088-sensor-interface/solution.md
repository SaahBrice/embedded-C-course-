# Full solution: Capstone: Sensor Port

This worked implementation demonstrates sample type, status, fake sensor. Compare its observable behavior and boundaries with yours; different code is valid when it preserves the same contract.
