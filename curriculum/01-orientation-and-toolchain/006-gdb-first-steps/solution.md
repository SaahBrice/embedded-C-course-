# Full solution: Inspect a Running Program

This worked implementation demonstrates breakpoints, step, print, backtrace. Compare its observable behavior and boundaries with yours; different code is valid when it preserves the same contract.

```c
/* Mission: Inspect a Running Program */
#include "task.h"
