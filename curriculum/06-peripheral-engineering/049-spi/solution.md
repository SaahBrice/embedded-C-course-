# Full solution: Transact over SPI

This worked implementation demonstrates clock polarity, phase, chip select, full duplex. Compare its observable behavior and boundaries with yours; different code is valid when it preserves the same contract.
